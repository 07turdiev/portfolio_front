...
const OUT_JS = join(here, '../src/data/projectedMap.js')
...
// 1) JS module (for legacy import — currently unused but kept)
writeFileSync(
  OUT_JS,
...
// 2) JSON file served from /data/projectedMap.json (runtime fetch — fast build)
...
console.log(
  `Wrote\n  ${OUT_JS}\n  ${OUT_JSON}\n  → regions=${regions.length}, districts=${totalDistricts}`
)
